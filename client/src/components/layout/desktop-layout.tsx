      ...
      <footer className="bg-neutral-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Dubai</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Bali</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Paris</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Tokyo</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Rome</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Maldives</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-lg font-heading font-semibold mb-4">Services</h4>
              <ul className="space-y-2">
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Travel Packages</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Hotel Bookings</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Cab Services</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Cruise Bookings</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Event Tickets</a></li>
                <li><a href="#" className="text-neutral-300 hover:text-white transition-colors">Travel Insurance</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-neutral-300">123 Travel Street, Suite 400<br/>New York, NY 10010</span>
                </li>
          ...
          <div className="border-t border-neutral-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm mb-4 md:mb-0">&copy; 2023 TravelEase. All rights reserved.</p>
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-neutral-400 text-sm hover:text-white transition-colors">Cookie Policy</a>
            </div>
          </div>
        </div>
      </footer>
